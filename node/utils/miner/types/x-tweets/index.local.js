/**
 * Local test script for x-tweets fetch implementation
 * 
 * This script tests the x-tweets fetch code by:
 * 1. Importing the fetch function directly
 * 2. Calling it with a test keyword
 * 3. Displaying the results in Subnet-111 format
 * 
 * Usage: node index.local.js [keyword] [limit]
 * 
 * Examples:
 *   node index.local.js
 *   node index.local.js bitcoin
 *   node index.local.js ethereum 20
 */
...
console.log('X-Tweets Fetch Test - Local Test');
console.log('='.repeat(80));
console.log('');
